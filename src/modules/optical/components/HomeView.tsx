...
import { getMockUser, clearMockAuth, isMockLoggedIn } from '@/shared/utils/mock-auth';
import { getLocation, DEFAULT_LOCATION, type SavedLocation } from '@/shared/utils/location';
