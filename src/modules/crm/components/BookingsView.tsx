          ...
          >
            <Link href={`/bookings/${b.id}`} className="flex-1 min-w-0 hover:opacity-90 transition-opacity">
              <div className="flex items-center justify-between gap-2">
                <span className="font-mono font-semibold text-slate-900 dark:text-white text-sm break-all">{b.id}</span>
              ...
              <p className="text-slate-500 dark:text-slate-500 text-[11px] mt-1 leading-snug">
                Use this booking ID with Eyekra staff on site — it is the same reference in the partner app for your visit and prescription.
              </p>
