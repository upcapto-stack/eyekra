...
import { isMockLoggedIn } from '@/shared/utils/mock-auth';
import { getCartItems, clearCart, type CartItem } from '@/shared/utils/cart';
import { getProductsList, isProductInCollection, type Product } from '@/shared/utils/products-data';
import { getLensesList } from '@/shared/utils/lenses-data';
import { getLocation, type SavedLocation } from '@/shared/utils/location';
