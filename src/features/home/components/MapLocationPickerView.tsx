...
import { addLocation, getLocations, setSelectedLocationIndex } from '@/lib/location';
import { reverseGeocodeNominatim, searchNominatim, type NominatimSearchResult } from '@/lib/nominatim';
